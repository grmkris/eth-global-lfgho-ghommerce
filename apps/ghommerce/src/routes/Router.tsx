...
function Root() {
  ...
  return (
    <div className="flex flex-col justify-start items-center text-center max-h-screen  custom-scrollbar">
      <div
        className="inline-block relative sm:border sm:border-gray-300 sm:rounded-2xl sm:shadow-xl z-50 my-1"
        style={{
